...
| C3 | Hybrid từ điển âm tiết + neural | Ứng viên trục kiến trúc |
...
1. Tỷ lệ câu sạch trong bộ test 6k (align sẽ đo được).
2. Non-word rate trên VSEC (Pilot 1).
3. Chất lượng nhiễu tổng hợp (Pilot 2).
4. Over-correction của baseline → chốt trục dữ liệu + trục kiến trúc cho Phase 2.
5. Phê duyệt Phase 0 (bản thiết kế này).
